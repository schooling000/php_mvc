...
<body>
    ...
    <div class="w3-main w3-padding" style="margin-left: 200px;">
        ...
        <div class="w3-row w3-margin-bottom">
            <div class="w3-twothird w3-row">
                <button class="w3-col l3 m3 w3-button w3-blue w3-small" onclick="document.getElementById('hop_thoai_them').style.display='block'">
        ...
        <div class="w3-responsive" style="max-height:400px;">
            <table class="w3-table-all w3-small" style="min-width: 1500px;">
                <tr class="w3-teal" style="position: sticky;top:0px;left:0px;">
                    ...
                    <th>Ngày hẹn</th>
                    <th>Ghi chú</th>
                    <th style="width:130px;">Tùy chọn</th>
                </tr>
                <tr>
                    <td>1</td>
                    <td>Nguyễn Văn A</td>
